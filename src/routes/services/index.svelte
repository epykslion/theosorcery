<main class="text-blueGray-100 bg-blueGray-700">
  ...
  <section id="intro">
    <div class="container flex flex-col items-center justify-center px-10 pb-24 mx-auto rounded-lg lg:-mt-12 lg:px-40">
      <img class="object-cover object-center w-full shadow-xl rounded-xl" alt="hero" src="/assets/website-mockup.webp">
    </div>
        ...
        <div class="w-full xl:w-1/4 md:w-2/6">
          <div class="relative flex flex-col h-full p-8 transition duration-500 ease-in-out transform bg-white border rounded-lg shadow-xl">
            ...
            <p class="flex items-center mb-2 text-base font-medium leading-relaxed text-blueGray-700">
              ...
              </span>A free audit of your current site
            </p>
        ...
        <div class="w-full xl:w-1/4 md:w-2/6">
          <div class="relative flex flex-col h-full p-8 transition duration-500 ease-in-out transform bg-white border rounded-lg shadow-xl ">
            ...
            <p class="flex items-center mb-2 text-base font-medium leading-relaxed text-blueGray-700">
              ...
              </span>Markdown support & lessons
            </p>
            <!--<button role="button" class="w-full px-4 py-2 mx-auto mt-6 text-base font-medium text-white transition duration-500 ease-in-out transform bg-blue-600 border-blue-600 rounded-md items-centerw-full focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 hover:bg-blue-700 ">Buy Now </button>-->
          </div>
        </div>
        <div class="w-full xl:w-1/4 md:w-2/6">
          <div class="relative flex flex-col h-full p-8 transition duration-500 ease-in-out transform bg-white border rounded-lg shadow-xl">
