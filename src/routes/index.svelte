...
<section
  ...
  <!--What I do-->
    <section class="py-4 mx-6 lg:mx-0">
     <div class="container relative flex flex-col max-w-6xl px-6 py-12 mx-auto overflow-hidden filter drop-shadow max-w-screen bg-gradient-to-bl from-blueGray-800 to-sky-800 rounded-3xl md:flex-row">
